...
const Contact = styled(NavLink)`
  ...
  z-index: 1;
`
const ContactWa = styled(NavLink)`
  color: ${(props) => (props.click ? props.theme.body : props.theme.text)};
  position: absolute;
  top: 4rem;
  right: calc(1rem + 2vw);
    ...
    <Suspense fallback={<Loading />}>
      ...
      >
        ...
        <Container>
          ...
          {mq ? (
            <Contact click={+click} target='_blank' to={{ pathname: 'mailto:aimanskie@gmail.com' }}>
              <motion.h3
                initial={{
                  y: -200,
            ...
            <Contact click={+false} target='_blank' to={{ pathname: 'mailto:aimanskie@gmail.com' }}>
              <motion.h3
                initial={{
                  y: -200,
                  transition: { type: 'spring', duration: 1.5, delay: 1 },
          ...
          {mq ? (
            <ContactWa
              ...
              target='_blank'
              to={{
                pathname: 'https://api.whatsapp.com/send?phone=60166360707',
              }}
            >
              <motion.h3
                initial={{
          ...
          {mq ? (
            <ContactMe
              ...
              target='_blank'
              to={{
                pathname: 'https://www.messenger.com/t/1875149096118566',
              }}
            >
              <motion.h3
                initial={{
